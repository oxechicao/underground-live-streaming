...
const animationOn = () => {
  ...
  document.getElementById('spotify-full-current-music').classList.remove('animate__zoomOut')
  document.getElementById('spotify-full-current-music').classList.add('animate__zoomIn')
...
const animationOff = () => {
  ...
  document.getElementById('spotify-full-current-music').classList.remove('animate__zoomIn')
  document.getElementById('spotify-full-current-music').classList.add('animate__zoomOut')
  document.getElementById('spotify-full').classList.remove('animate__flipOutX')
...
const showSpotify = ({ name, nameArtist, albumImage, sizeBannerBg }) => {
  animationOn()
  ...
  document.getElementById('spotify-imagem-full-horizontal').src = albumImage
